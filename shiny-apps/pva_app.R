               ...
               wellPanel(
                     ...
                     fluidRow(
                       column(12,
                              ...
                              fluidRow(column(6, sliderInput("nstates", label = "Number of states",
                                                             value = 6, min = 2, max = 3, step = 1)),
                                       column(2, numericInput("prop1", label = "1", value = 0.1,
                                                              min = 0, max = 1, step = 0.1)),
                                       column(2, numericInput("prop2", label = "2", value = 0.2,
                                                              min = 0, max = 1, step = 0.1)),
                                       column(2, numericInput("prop3", label = "3", value = 0.3,
                                                              min = 0, max = 1, step = 0.1))),
